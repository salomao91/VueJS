...
// ./pages folder => components which is loaded through the router.
// ./components folder => components that are embedded into other components templates.

import TeamList from './pages/TeamsList.vue';
import UserList from './pages/UsersList.vue';
import TeamMembers from './components/teams/TeamMembers.vue';   // it's both embedded via other components and through router parameter.
